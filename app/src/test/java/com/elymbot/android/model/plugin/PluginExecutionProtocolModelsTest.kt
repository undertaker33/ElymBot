...
class PluginExecutionProtocolModelsTest {
    ...
    fun trigger_source_enum_covers_phase2_protocol_sources_with_stable_wire_values() {
        val enumClass = loadClass("com.elymbot.android.model.plugin.PluginTriggerSource")
    ...
    fun host_action_whitelist_enum_covers_phase2_capabilities_with_stable_wire_values() {
        val enumClass = loadClass("com.elymbot.android.model.plugin.PluginHostAction")
    ...
    fun execution_context_exposes_phase2_required_fields() {
        val contextClass = loadClass("com.elymbot.android.model.plugin.PluginExecutionContext")
    ...
    fun result_and_schema_models_exist_without_compose_type_leaks() {
        loadClass("com.elymbot.android.model.plugin.PluginExecutionResult")
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.TextResult",
            expectedFieldNames = listOf("text", "markdown", "displayTitle"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.CardResult",
            expectedFieldNames = listOf("card"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.MediaResult",
            expectedFieldNames = listOf("items"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.HostActionRequest",
            expectedFieldNames = listOf("action", "title", "payload"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.SettingsUiRequest",
            expectedFieldNames = listOf("schema"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.NoOp",
            expectedFieldNames = listOf("reason"),
        )
        assertHasFieldNames(
            className = "com.elymbot.android.model.plugin.ErrorResult",
            expectedFieldNames = listOf("message", "code", "recoverable"),
        )
        assertNoComposeTypes("com.elymbot.android.model.plugin.PluginCardSchema")
        assertNoComposeTypes("com.elymbot.android.model.plugin.PluginSettingsSchema")
    }
    ...
    fun execution_context_round_trip_preserves_nested_protocol_fields() {
        ...
        val encoded = jsonCodec.javaClass
            .getDeclaredMethod("encodeExecutionContext", loadClass("com.elymbot.android.model.plugin.PluginExecutionContext"))
            .invoke(jsonCodec, decoded) as JSONObject

        assertEquals("on_command", encoded.getString("trigger"))
        assertEquals("com.elymbot.demo", encoded.getString("pluginId"))
        ...
        assertEquals("ElymBot", encoded.getJSONObject("bot").getString("displayName"))
    ...
    fun result_round_trip_preserves_card_and_settings_schema_without_compose_details() {
        ...
        val encodedCard = jsonCodec.javaClass
            .getDeclaredMethod("encodeResult", loadClass("com.elymbot.android.model.plugin.PluginExecutionResult"))
    ...
    private fun loadProtocolJsonCodec(): Any {
        val clazz = loadClass("com.elymbot.android.model.plugin.PluginExecutionProtocolJson")
