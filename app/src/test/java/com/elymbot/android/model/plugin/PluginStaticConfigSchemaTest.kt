...
class PluginStaticConfigSchemaTest {
    ...
    fun static_config_schema_round_trip_preserves_core_desktop_compatible_fields() {
        ...
        val encoded = jsonCodec.javaClass
            .getDeclaredMethod("encodeSchema", loadClass("com.elymbot.android.model.plugin.PluginStaticConfigSchema"))
        ...
        assertEquals("You are ElymBot.", encoded.getJSONObject("prompt").getString("default"))
    ...
    private fun loadStaticConfigJsonCodec(): Any {
        val clazz = loadClass("com.elymbot.android.model.plugin.PluginStaticConfigJson")
