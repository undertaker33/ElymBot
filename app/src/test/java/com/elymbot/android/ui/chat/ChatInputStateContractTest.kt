...
class ChatInputStateContractTest {
    ...
    private val chatScreenFile = resolvePreferredFile(
        "../feature/chat/presentation/src/main/java/com/elymbot/android/feature/chat/presentation/ChatScreen.kt",
        "feature/chat/presentation/src/main/java/com/elymbot/android/feature/chat/presentation/ChatScreen.kt",
        "app/src/main/java/com/elymbot/android/feature/chat/presentation/ChatScreen.kt",
        "src/main/java/com/elymbot/android/feature/chat/presentation/ChatScreen.kt",
    )
    private val chatInputFile = resolvePreferredFile(
        ...
        "feature/chat/presentation/src/main/java/com/elymbot/android/feature/chat/presentation/ChatInputComponents.kt",
        "app/src/main/java/com/elymbot/android/feature/chat/presentation/ChatInputComponents.kt",
        "src/main/java/com/elymbot/android/feature/chat/presentation/ChatInputComponents.kt",
    )
    ...
    fun `feature chat sources exist and legacy ui chat sources do not`() {
        ...
        assertFalse(
            ...
            File("app/src/main/java/com/elymbot/android/ui/chat/ChatScreen.kt").exists() ||
                File("src/main/java/com/elymbot/android/ui/chat/ChatScreen.kt").exists(),
        )
        assertFalse(
            "Legacy ui/chat ChatInputComponents.kt must not be used to satisfy this contract",
            File("app/src/main/java/com/elymbot/android/ui/chat/ChatInputComponents.kt").exists() ||
                File("src/main/java/com/elymbot/android/ui/chat/ChatInputComponents.kt").exists(),
        )
    }
