...
import com.elymbot.android.feature.plugin.runtime.PluginRuntimeLogBusProvider
...
class PluginCatalogSynchronizerTest {
    ...
    fun sync_normalizes_github_blob_catalog_url_before_fetching_existing_source() = runBlocking {
        val blobSource = subscribedSource().copy(
            catalogUrl = "https://github.com/undertaker33/elymbot_android_plugin_memes/blob/main/publish/0.1.0/repository/catalog.json",
        )
        val rawUrl = "https://raw.githubusercontent.com/undertaker33/elymbot_android_plugin_memes/main/publish/0.1.0/repository/catalog.json"
