 ...
 *
 * Manual run:
 * `.\gradlew.bat :app:testDebugUnitTest --tests "com.elymbot.android.feature.plugin.runtime.PluginV2QuickJsMessageIntegrationTest"`
 */
    ...
    private inline fun withBootstrappedFixture(
        ...
        try {
            ...
            val installRecord = samplePluginV2InstallRecord(
                pluginId = "com.elymbot.samples.$name",
