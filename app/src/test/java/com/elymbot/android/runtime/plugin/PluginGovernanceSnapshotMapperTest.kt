...
import com.elymbot.android.model.plugin.DiagnosticSeverity
import com.elymbot.android.model.plugin.PluginAutoRecoveryStateSnapshot
import com.elymbot.android.model.plugin.PluginBootstrapStatusSnapshot
import com.elymbot.android.model.plugin.PluginCapabilityGrantSnapshot
import com.elymbot.android.model.plugin.PluginConfigStateSummary
...
import com.elymbot.android.model.plugin.PluginWorkspaceStateSummary
...
class PluginGovernanceSnapshotMapperTest {
    ...
    fun mapper_aggregates_phase6_runtime_failure_registry_and_diagnostics_sources() {
        ...
        val failureSnapshot = PluginFailureSnapshot(
            ...
            failureCategory = com.elymbot.android.model.plugin.PluginFailureCategory.PermissionDenied,
            isSuspended = true,
    ...
    fun mapper_distinguishes_all_shared_definition_runtime_health_states_and_ignores_recovered_history() {
        ...
        val unsupportedProtocol = governanceInstallRecord(
            ...
            compatibilityState = com.elymbot.android.model.plugin.PluginCompatibilityState.fromChecks(
    ...
    fun mapper_normalizes_expired_suspension_before_projecting_governance_state() {
        ...
        val expiredSuspension = PluginFailureSnapshot(
            ...
            failureCategory = com.elymbot.android.model.plugin.PluginFailureCategory.RuntimeError,
            isSuspended = true,
    ...
    private data class GovernanceRuntimeFixture(
        val installRecord: com.elymbot.android.model.plugin.PluginInstallRecord,
    ...
    private fun governanceInstallRecord(
        ...
        compatibilityState: com.elymbot.android.model.plugin.PluginCompatibilityState =
            com.elymbot.android.model.plugin.PluginCompatibilityState.evaluated(
                protocolSupported = true,
                minHostVersionSatisfied = true,
                maxHostVersionSatisfied = true,
            ),
