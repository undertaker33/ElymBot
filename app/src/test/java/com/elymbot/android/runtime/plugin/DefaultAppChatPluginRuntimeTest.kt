...
class DefaultAppChatPluginRuntimeTest {
            ...
            input = PluginV2LlmPipelineInput(
                ...
                messages = listOf(
                    PluginProviderMessageDto(
                        ...
                        parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("hello runtime")),
                    ),
                ),
            ...
            val result = DefaultAppChatPluginRuntime.runLlmPipeline(
                input = PluginV2LlmPipelineInput(
                    ...
                    messages = listOf(
                        PluginProviderMessageDto(
                            role = PluginProviderMessageRole.USER,
                            parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("hello runtime bypass")),
                        ),
                    ),
                    invokeProvider = { request, _ ->
                        com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
    ...
    fun default_app_chat_runtime_delivers_admitted_pipeline_with_single_runtime_entrypoint() = runBlocking {
            ...
            request = PluginV2HostLlmDeliveryRequest(
                pipelineInput = PluginV2LlmPipelineInput(
                    ...
                    messages = listOf(
                        PluginProviderMessageDto(
                            role = PluginProviderMessageRole.USER,
                            parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("hello delivery")),
                        ),
                    ),
        ...
        assertTrue(result is com.elymbot.android.feature.plugin.domain.runtime.PluginV2HostLlmDeliveryResult.Sent)
        result as com.elymbot.android.feature.plugin.domain.runtime.PluginV2HostLlmDeliveryResult.Sent
            ...
            request = PluginV2HostLlmDeliveryRequest(
                pipelineInput = PluginV2LlmPipelineInput(
                    ...
                    messages = listOf(
                        PluginProviderMessageDto(
                            role = PluginProviderMessageRole.USER,
                            parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("hello host tool")),
                        ),
                    ),
                    invokeProvider = { requestPayload, _ ->
            ...
            request = PluginV2HostLlmDeliveryRequest(
                pipelineInput = PluginV2LlmPipelineInput(
                    ...
                    messages = listOf(
                        PluginProviderMessageDto(
                            role = PluginProviderMessageRole.USER,
                            parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("hello disabled host tool")),
                        ),
                    ),
