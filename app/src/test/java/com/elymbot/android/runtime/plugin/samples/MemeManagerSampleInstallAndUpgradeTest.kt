...
class MemeManagerSampleInstallAndUpgradeTest {
    ...
    fun sample_package_can_install_from_catalog_and_persists_repository_origin_fields() = runBlocking {
        ...
        try {
            ...
            val expectedUrl = "https://samples.elymbot.local/catalog/packages/meme-manager-1.0.0.zip"
    ...
    fun sample_plugin_upgrade_reinstalls_v2_contract_and_packaged_assets_from_catalog_package() = runBlocking {
        ...
        try {
            ...
            val installUrl = "https://samples.elymbot.local/catalog/packages/meme-manager-1.0.0.zip"
            val upgradeUrl = "https://samples.elymbot.local/catalog/packages/meme-manager-1.1.0.zip"
        ...
        try {
            ...
            installer.install(
                PluginInstallIntent.catalogVersion(
                    pluginId = SAMPLE_PLUGIN_ID,
                    version = "1.0.0",
                    packageUrl = "https://samples.elymbot.local/catalog/packages/meme-manager-1.0.0.zip",
                    catalogSourceId = "sample",
                ),
            )
            ...
            PluginRepository.replaceRepositoryCatalog(
                com.elymbot.android.feature.plugin.data.catalog.PluginCatalogJson.decodeRepositorySource(fixtureJson).copy(
                    sourceId = "sample",
                    catalogUrl = "https://samples.elymbot.local/catalog/meme-manager.json",
                ),
            )
...
private const val SAMPLE_PLUGIN_ID = "com.elymbot.samples.meme_manager"
