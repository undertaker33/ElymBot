...
@Ignore(
    "Gated QuickJS integration asset. Run manually with .\\gradlew.bat :app:testDebugUnitTest --tests \"com.elymbot.android.feature.plugin.runtime.PluginV2QuickJsBootstrapIntegrationTest\" in a JVM-native QuickJS environment.",
)
