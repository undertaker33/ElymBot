...
class PluginFailureGuardTest {
    ...
    fun failure_guard_isolates_suspension_by_trigger_scope() {
        ...
        guard.recordFailure(
            ...
            trigger = com.elymbot.android.model.plugin.PluginTriggerSource.BeforeSendMessage,
            errorSummary = "socket timeout",
        )
        guard.recordFailure(
            pluginId = "plugin-scoped",
        ...
        assertFalse(
            guard.isSuspended(
                pluginId = "plugin-scoped",
                trigger = com.elymbot.android.model.plugin.PluginTriggerSource.OnCommand,
            ),
        )
    }
    ...
    fun persistent_failure_store_round_trips_through_plugin_repository() {
        var record: com.elymbot.android.model.plugin.PluginInstallRecord? = samplePluginInstallRecord(
...
private fun com.elymbot.android.model.plugin.PluginInstallRecord.withFailureState(
