...
import com.elymbot.android.feature.cron.domain.CronJobRunNowResult
...
import com.elymbot.android.model.CronJob
import com.elymbot.android.model.CronJobExecutionRecord
...
class ActiveCapabilityToolSourceProviderTest {
    ...
    fun list_bindings_hides_active_capability_tools_during_scheduled_task_wakeup() = runBlocking {
        val provider = ActiveCapabilityToolSourceProvider(
            ...
            promptStrings = com.elymbot.android.feature.cron.runtime.TestActiveCapabilityPromptStrings,
            ),
            promptStrings = com.elymbot.android.feature.cron.runtime.TestActiveCapabilityPromptStrings,
