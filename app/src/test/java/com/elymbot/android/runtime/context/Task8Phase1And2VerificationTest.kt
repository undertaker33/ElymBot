...
class Task8Phase1And2VerificationTest {
    ...
    fun chat_view_model_has_no_track_b_legacy_path() {
        val vmClass = Class.forName("com.elymbot.android.ui.viewmodel.ChatViewModel")
    ...
    fun http_failure_model_covers_all_failure_types() {
        ...
        for (type in failureClasses) {
            val cls = runCatching {
                Class.forName("com.elymbot.android.core.runtime.network.RuntimeNetworkFailure\$$type")
            }.getOrNull()
    ...
    fun provider_http_client_delegates_requests_to_runtime_transport() {
        ...
        val providerClient = OkHttpElymBotHttpClient(transport = transport)
