        ...
        val error = runCatching {
            coordinator.runPreSendStages(
                input = pipelineInput(
                    ...
                    com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.Streaming(
                        events = listOf(
    ...
    private suspend fun executePipelineForMode(
        ...
        val result = coordinator.runPreSendStages(
            input = pipelineInput(
                ...
                when (streamingMode) {
                    PluginV2StreamingMode.NON_STREAM -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        PluginLlmResponse(
                            requestId = request.requestId,
                            providerId = request.selectedProviderId,
                            modelId = request.selectedModelId,
