...
class PluginV2ToolLoopCoordinatorTest {
        ...
        val result = coordinator.runPreSendStages(
            input = pipelineInput(
                ...
                when (providerCalls.incrementAndGet()) {
                    1 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        PluginLlmResponse(
                    ...
                    else -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        PluginLlmResponse(
                            requestId = request.requestId,
                            providerId = request.selectedProviderId,
                            modelId = request.selectedModelId,
    ...
    fun web_search_tool_round_reinjects_empty_assistant_tool_calls_before_tool_result() = runBlocking {
        ...
        coordinator.runPreSendStages(
            input = pipelineInput(
                event = sampleMessageEvent(rawText = "search ElymBot news"),
                streamingMode = PluginV2StreamingMode.NON_STREAM,
                        ...
                        PluginLlmResponse(
                            ...
                            toolCalls = listOf(
                                PluginLlmToolCall(
                                    ...
                                    toolName = "web_search",
                                    arguments = linkedMapOf("query" to "ElymBot"),
                                ),
                            ),
                        ),
                    )
        ...
        assertEquals(
            "web search result",
            tool.parts.filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>().single().text,
        )
    }
                ...
                when (providerCalls.incrementAndGet()) {
                    1 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        ...
                        val toolText = request.messages
                            ...
                            .parts
                            .filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>()
                            .joinToString("\n") { it.text }
                        ...
                        com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                            PluginLlmResponse(
                                requestId = request.requestId,
                                providerId = request.selectedProviderId,
                                modelId = request.selectedModelId,
        ...
        val result = coordinator.runPreSendStages(
            input = pipelineInput(
                ...
                when (providerCalls.incrementAndGet()) {
                    ...
                    2 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        PluginLlmResponse(
                            requestId = request.requestId,
                            providerId = request.selectedProviderId,
                            modelId = request.selectedModelId,
    ...
    fun tool_results_are_reinjected_as_tool_role_messages_with_text_and_canonical_json_parts() = runBlocking {
        ...
        val parts = lastMessage.parts.filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>()
    ...
    fun multiple_tool_results_are_reinjected_after_single_assistant_tool_call_round_with_original_ids() = runBlocking {
        ...
        assertEquals(PluginProviderMessageRole.ASSISTANT, assistant.role)
        assertEquals("Need two tools", assistant.parts.filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>().single().text)
    ...
    fun streaming_tool_call_delta_preserves_original_tool_call_id() = runBlocking {
        ...
        coordinator.runPreSendStages(
            input = pipelineInput(
                ...
                when (providerCalls.incrementAndGet()) {
                    1 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.Streaming(
                        events = listOf(
    ...
    fun plugin_request_paths_cannot_author_tool_messages_but_host_reinjection_survives_following_request_hooks() = runBlocking {
        ...
        val toolAuthoredByPlugin = PluginProviderMessageDto(
            ...
            name = "fake-tool",
            parts = listOf(com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart("plugin-authored")),
            ...
            input = pipelineInput(
                ...
                when (providerCalls.incrementAndGet()) {
                    1 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        ...
                        val textParts = toolMessage.parts.filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>()
                        ...
                        assertEquals(
                            ...
                            toolMessages.count { message ->
                                message.name == "fake-tool" ||
                                    message.parts.filterIsInstance<com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart>()
    ...
    fun repeated_tool_across_rounds_generates_new_tool_call_id_and_attempt_index_is_zero() = runBlocking {
        ...
        val result = coordinator.runPreSendStages(
            input = pipelineInput(
                ...
                when (providerCalls.incrementAndGet()) {
                    1, 2 -> com.elymbot.android.feature.plugin.domain.runtime.PluginV2ProviderInvocationResult.NonStreaming(
                        PluginLlmResponse(
                            requestId = request.requestId,
                            providerId = request.selectedProviderId,
                            modelId = request.selectedModelId,
        ...
        return PluginV2LlmPipelineInput(
            ...
            messages = listOf(
                PluginProviderMessageDto(
                    ...
                    parts = listOf(
                        com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessagePartDto.TextPart(event.rawText),
                    ),
                ),
            ),
