...
class AppBackupRepositoryCompatibilityTest {
    ...
    fun importLegacyManifest_restoresAggregateBackedRepositories() = runBlocking {
        ...
        assertEquals(listOf("elymbot", "assistant"), restoredBot.triggerWords)
    ...
    private fun legacyManifestJson(): JSONObject {
        return JSONObject(
            """
            {
              "schema": "elymbot-android-full-backup-v1",
                  ...
                  "records": [
                    {
                      ...
                      "triggerWords": ["elymbot", "assistant"],
...
private class FailingConversationAggregateDao : ConversationAggregateDao() {
    ...
    override suspend fun replaceAll(writeModels: List<com.elymbot.android.data.db.ConversationAggregateWriteModel>) {
