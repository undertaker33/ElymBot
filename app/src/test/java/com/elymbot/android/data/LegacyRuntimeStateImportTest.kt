...
class LegacyRuntimeStateImportTest {
    ...
    fun `bridge config merge replaces legacy tmp commands with runtime defaults`() {
        val defaults = NapCatBridgeConfig(
            startCommand = "/system/bin/sh /data/user/0/com.elymbot.android/files/runtime/scripts/start_napcat.sh",
            stopCommand = "/system/bin/sh /data/user/0/com.elymbot.android/files/runtime/scripts/stop_napcat.sh",
            statusCommand = "/system/bin/sh /data/user/0/com.elymbot.android/files/runtime/scripts/status_napcat.sh",
            commandPreview = "/system/bin/sh /data/user/0/com.elymbot.android/files/runtime/scripts/start_napcat.sh",
        )
