...
class NapCatLoginDiagnosticsTest {
    ...
    fun builds_runtime_diagnostics_with_config_snapshot_and_log_tail() {
        ...
        assertTrue(lines.any { it.contains("webui.json") && it.contains("elymbot_android_webui") })
        assertTrue(lines.any { it.contains("onebot11.json") && it.contains("elymbot_android_bridge") })
