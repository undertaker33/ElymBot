...
class ElymBotDatabaseSchemaContractTest {
    @Test
    ...
    fun version20Schema_containsCronExecutionRecordsAndExplicitCronTargetColumns() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/20.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/20.json"),
    ...
    fun version22Schema_containsScheduledTaskConversationContextFlag() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/22.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/22.json"),
    ...
    fun version21Schema_containsPluginStateEntries_and_configSnapshotsNoLongerCascadeFromInstallRecords() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/21.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/21.json"),
    ...
    fun version10Schema_removesLegacyJsonColumns() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/10.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/10.json"),
    ...
    fun version11Schema_containsPluginFailureStateColumns() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/11.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/11.json"),
    ...
    fun version12Schema_containsPluginCatalogTrackingColumns() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/12.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/12.json"),
    ...
    fun version13Schema_containsPluginCatalogSyncColumns() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/13.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/13.json"),
    ...
    fun version14Schema_containsPluginConfigSnapshotTable() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/14.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/14.json"),
    ...
    fun version15Schema_containsDownloadTasksTable() {
        val schemaFile = listOf(
            File("schemas/com.elymbot.android.data.db.ElymBotDatabase/15.json"),
            File("app/schemas/com.elymbot.android.data.db.ElymBotDatabase/15.json"),
    ...
    fun pluginAggregate_mapper_roundTripsWriteModelFields() {
        val record = com.elymbot.android.model.plugin.PluginInstallRecord.restoreFromPersistedState(
