...
class GlobalSingletonAllowlistContractTest {
    ...
    fun production_code_must_not_add_new_manual_database_singleton_access() {
        ...
        assertTrue(
            "Production code must use injected ElymBotDatabase instead of ElymBotDatabase.get(...). Found: $violations",
            violations.isEmpty(),
        )
    }
    ...
    fun ui_sources_must_not_read_legacy_runtime_logging_facades() {
        val forbiddenImports = listOf(
            ...
            "import com.elymbot.android.core.common.logging.RuntimeLogCleanupRepository",
        )
        val violations = productionKotlinFiles()
            .filter { file ->
    ...
    fun container_extractors_must_not_read_legacy_runtime_logging_facades() {
        ...
        val forbiddenReferences = listOf(
            "import com.elymbot.android.core.common.logging.RuntimeLogRepository",
            "import com.elymbot.android.core.common.logging.AppLogger",
            "com.elymbot.android.core.common.logging.RuntimeLogRepository",
            "com.elymbot.android.core.common.logging.AppLogger",
        )
        val violations = productionKotlinFiles()
