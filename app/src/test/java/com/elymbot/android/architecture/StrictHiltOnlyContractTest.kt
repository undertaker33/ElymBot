...
class StrictHiltOnlyContractTest {
    ...
    private val productionSourceRoots: List<Path> = listOf(
        ...
        projectRoot.resolve("core/network/src/main/java/com/elymbot/android"),
        projectRoot.resolve("core/runtime/src/main/java/com/elymbot/android"),
        projectRoot.resolve("core/runtime-search/src/main/java/com/elymbot/android"),
        projectRoot.resolve("core/runtime-tool/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/chat/presentation/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/chat/runtime/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/plugin/data/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/plugin/presentation/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/plugin/runtime/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/qq/data/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/qq/impl/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/qq/presentation/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/qq/runtime/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/provider/runtime/src/main/java/com/elymbot/android"),
        projectRoot.resolve("feature/voiceasset/data/src/main/java/com/elymbot/android"),
    ...
    fun phase4_hilt_shells_must_not_read_static_repository_or_shared_singleton_sources_directly() {
        val forbiddenTokensByFile = mapOf(
            ...
            "data/http/ElymBotHttpClient.kt" to listOf(
            ...
            "feature/plugin/data/FeaturePluginRepository.kt" to listOf(
                "ElymBotDatabase.get(context)",
                "resolveProductionElymBotDatabase(context)",
