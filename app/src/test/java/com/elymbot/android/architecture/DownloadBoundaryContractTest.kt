...
class DownloadBoundaryContractTest {
    ...
    private val downloadApiRoot: Path =
        projectRoot.resolve("download/api/src/main/java/com/elymbot/android/download")
    private val downloadImplRoot: Path =
        projectRoot.resolve("download/impl/src/main/java/com/elymbot/android/download")
    ...
    fun download_impl_manifest_must_own_foreground_service_declaration() {
        ...
        assertTrue(
            ...
            !appManifest.contains("""com.elymbot.android.download.DownloadForegroundService"""),
        )
        assertTrue(
            "download/impl AndroidManifest.xml must register the download foreground service by real implementation class.",
            downloadImplManifest.contains("""android:name="com.elymbot.android.download.DownloadForegroundService""""),
        )
        assertTrue(
