...
class HiltExitContractTest {
    ...
    fun application_must_not_create_legacy_container() {
        val file = mainRoot.resolve("ElymBotApplication.kt")
        assertTrue("ElymBotApplication.kt must exist", file.exists())
        val text = file.readText()
        assertTrue(
            "ElymBotApplication must remain @HiltAndroidApp",
            text.contains("@HiltAndroidApp"),
        )
        assertTrue(
            "ElymBotApplication must implement WorkManager Configuration.Provider for HiltWorkerFactory",
            text.contains("Configuration.Provider") && text.contains("HiltWorkerFactory"),
        )
        assertTrue(
            "ElymBotApplication must not manually create ElymBotAppContainer after phase 5",
        ...
        assertTrue(
            "ElymBotApplication must keep startup ownership behind AppBootstrapper instead of injecting startup chains directly: $violations",
            violations.isEmpty(),
        )
    }
    ...
    private fun productionViewModelFiles(): List<Path> {
        return listOf(
            "app/src/main/java/com/elymbot/android/ui/viewmodel/BridgeViewModel.kt",
            "feature/bot/presentation/src/main/java/com/elymbot/android/feature/bot/presentation/BotViewModel.kt",
            "feature/provider/presentation/src/main/java/com/elymbot/android/feature/provider/presentation/ProviderViewModel.kt",
            "feature/config/presentation/src/main/java/com/elymbot/android/feature/config/presentation/ConfigViewModel.kt",
            "feature/chat/presentation/src/main/java/com/elymbot/android/feature/chat/presentation/ConversationViewModel.kt",
            "feature/persona/presentation/src/main/java/com/elymbot/android/feature/persona/presentation/PersonaViewModel.kt",
            "feature/plugin/presentation/src/main/java/com/elymbot/android/feature/plugin/presentation/PluginViewModel.kt",
            "feature/qq/presentation/src/main/java/com/elymbot/android/feature/qq/presentation/QQLoginViewModel.kt",
            "feature/chat/presentation/src/main/java/com/elymbot/android/feature/chat/presentation/ChatViewModel.kt",
            "feature/voiceasset/presentation/src/main/java/com/elymbot/android/ui/settings/RuntimeAssetViewModel.kt",
            "app/src/main/java/com/elymbot/android/ui/viewmodel/RuntimeLogViewModel.kt",
            "feature/cron/presentation/src/main/java/com/elymbot/android/ui/settings/CronJobsViewModel.kt",
