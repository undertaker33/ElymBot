...
class HiltFoundationContractTest {
    ...
    fun application_must_be_hilt_android_app() {
        ...
        assertTrue(
            "ElymBotApplication must be annotated with @HiltAndroidApp in phase 4",
    ...
    fun di_hilt_foundation_files_must_exist() {
        val required = listOf(
            listOf(
                ...
                projectRoot.resolve("app-integration/src/main/java/com/elymbot/android/di/hilt/AppDispatchersModule.kt"),
            ),
            listOf(mainRoot.resolve("di/hilt/RuntimeServicesModule.kt")),
            listOf(
                mainRoot.resolve("di/hilt/RepositoryPortModule.kt"),
                projectRoot.resolve("app-integration/src/main/java/com/elymbot/android/di/hilt/RepositoryPortModule.kt"),
            ),
