...
class SettingsPresentationBoundaryContractTest {
    ...
    private val legacyAppSettingsRoot: Path =
        projectRoot.resolve("app/src/main/java/com/elymbot/android/feature/settings/presentation")
    ...
    private fun isForbiddenSettingsPresentationImport(importName: String): Boolean {
        return importName == "com.elymbot.android.data.db" ||
            importName.startsWith("com.elymbot.android.data.db.") ||
            importName.startsWith("com.elymbot.android.core.db.backup.") ||
            importName.startsWith("com.elymbot.android.core.runtime.cache.") ||
            importName.startsWith("com.elymbot.android.core.runtime.container.") ||
            importName.startsWith("com.elymbot.android.feature.plugin.runtime.") ||
            importName.startsWith("com.elymbot.android.feature.plugin.data.") ||
            importName.startsWith("com.elymbot.android.runtime.")
    }
