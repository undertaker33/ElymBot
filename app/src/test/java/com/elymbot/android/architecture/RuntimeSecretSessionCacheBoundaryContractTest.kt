...
class RuntimeSecretSessionCacheBoundaryContractTest {
    ...
    private val coarseRuntimeRoot: Path =
        projectRoot.resolve("core/runtime/src/main/java/com/elymbot/android/core/runtime")
    ...
    fun production_hot_paths_must_not_call_legacy_static_secret_or_session_objects() {
        val forbiddenImports = listOf(
            "import com.elymbot.android.core.runtime.secret.AppSecretStore",
            "import com.elymbot.android.core.runtime.secret.RuntimeSecretRepository",
