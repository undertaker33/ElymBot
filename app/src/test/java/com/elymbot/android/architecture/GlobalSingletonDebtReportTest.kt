...
class GlobalSingletonDebtReportTest {
    ...
    private val sourceRoots: List<Path> = listOf(
        ...
        "core/backup/src/main/java/com/elymbot/android",
        "core/common/src/main/java/com/elymbot/android",
        "core/db/src/main/java/com/elymbot/android",
        "core/logging/src/main/java/com/elymbot/android",
        "core/network/src/main/java/com/elymbot/android",
        "core/runtime/src/main/java/com/elymbot/android",
        "core/runtime-audio/src/main/java/com/elymbot/android",
        "core/runtime-cache/src/main/java/com/elymbot/android",
        "core/runtime-container/src/main/java/com/elymbot/android",
        "core/runtime-context/src/main/java/com/elymbot/android",
        "core/runtime-llm/src/main/java/com/elymbot/android",
        "core/runtime-search/src/main/java/com/elymbot/android",
        "core/runtime-secret/src/main/java/com/elymbot/android",
        "core/runtime-session/src/main/java/com/elymbot/android",
        "core/runtime-tool/src/main/java/com/elymbot/android",
        "core/ui/src/main/java/com/elymbot/android",
        "download/api/src/main/java/com/elymbot/android",
        "download/impl/src/main/java/com/elymbot/android",
        "feature/bot/api/src/main/java/com/elymbot/android",
        "feature/bot/data/src/main/java/com/elymbot/android",
        "feature/bot/impl/src/main/java/com/elymbot/android",
        "feature/bot/presentation/src/main/java/com/elymbot/android",
        "feature/chat/api/src/main/java/com/elymbot/android",
        "feature/chat/impl/src/main/java/com/elymbot/android",
        "feature/chat/presentation/src/main/java/com/elymbot/android",
        "feature/chat/runtime/src/main/java/com/elymbot/android",
        "feature/config/api/src/main/java/com/elymbot/android",
        "feature/config/data/src/main/java/com/elymbot/android",
        "feature/config/impl/src/main/java/com/elymbot/android",
        "feature/config/presentation/src/main/java/com/elymbot/android",
        "feature/conversation/api/src/main/java/com/elymbot/android",
        "feature/conversation/data/src/main/java/com/elymbot/android",
        "feature/cron/api/src/main/java/com/elymbot/android",
        "feature/cron/data/src/main/java/com/elymbot/android",
        "feature/cron/impl/src/main/java/com/elymbot/android",
        "feature/cron/presentation/src/main/java/com/elymbot/android",
        "feature/cron/runtime/src/main/java/com/elymbot/android",
        "feature/persona/api/src/main/java/com/elymbot/android",
        "feature/persona/data/src/main/java/com/elymbot/android",
        "feature/persona/impl/src/main/java/com/elymbot/android",
        "feature/persona/presentation/src/main/java/com/elymbot/android",
        "feature/plugin/api/src/main/java/com/elymbot/android",
        ...
        "feature/provider/api/src/main/java/com/elymbot/android",
        "feature/provider/data/src/main/java/com/elymbot/android",
        "feature/provider/impl/src/main/java/com/elymbot/android",
        "feature/provider/presentation/src/main/java/com/elymbot/android",
        "feature/provider/runtime/src/main/java/com/elymbot/android",
        "feature/qq/api/src/main/java/com/elymbot/android",
        ...
        "feature/resource/api/src/main/java/com/elymbot/android",
        "feature/resource/data/src/main/java/com/elymbot/android",
        "feature/resource/impl/src/main/java/com/elymbot/android",
        "feature/resource/presentation/src/main/java/com/elymbot/android",
        "feature/settings/api/src/main/java/com/elymbot/android",
        "feature/settings/presentation/src/main/java/com/elymbot/android",
        "feature/voiceasset/api/src/main/java/com/elymbot/android",
        "feature/voiceasset/data/src/main/java/com/elymbot/android",
        "feature/voiceasset/presentation/src/main/java/com/elymbot/android",
    ...
    fun generate_global_singleton_debt_report() {
        ...
        val manualDatabaseGetCallers = productionFiles
            .filter { file -> file.readText(UTF_8).contains("ElymBotDatabase.get(") }
            .map(::relativePath)
            .filterNot { path -> path == "data/db/ElymBotDatabase.kt" }
            .sorted()
        ...
        val report = buildString {
            ...
            appendLine()
            appendSection("manual ElymBotDatabase.get callers", manualDatabaseGetCallers)
            appendLine()
        ...
        assertTrue(
            ...
            listOf(
                ...
                "manual ElymBotDatabase.get callers",
