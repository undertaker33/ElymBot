...
internal object DefaultAppChatPluginRuntime : AppChatPluginRuntime, AppChatLlmPipelineRuntime {
    override fun execute(
        trigger: com.elymbot.android.model.plugin.PluginTriggerSource,
        contextFactory: (PluginRuntimePlugin) -> com.elymbot.android.model.plugin.PluginExecutionContext,
