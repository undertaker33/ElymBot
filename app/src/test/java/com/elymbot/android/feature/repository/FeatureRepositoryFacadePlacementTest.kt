package com.elymbot.android.feature.repository
...
class FeatureRepositoryFacadePlacementTest {
    ...
    fun bot_and_config_repositories_do_not_expose_production_singleton_facades() {
        val productionSources = listOf(
            "feature/bot/data/src/main/java/com/elymbot/android/feature/bot/data/FeatureBotRepository.kt" to "FeatureBotRepository",
            "feature/config/data/src/main/java/com/elymbot/android/feature/config/data/FeatureConfigRepository.kt" to "FeatureConfigRepository",
        )
