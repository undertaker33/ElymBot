...
class RuntimeLogCompatFacadePlacementTest {
    ...
    fun legacy_runtime_log_facades_are_not_production_sources() {
        val productionCompatFiles = listOf(
            "core/runtime/src/main/java/com/elymbot/android/core/common/logging/AppLogger.kt",
            "core/runtime/src/main/java/com/elymbot/android/core/common/logging/RuntimeLogRepository.kt",
            "core/runtime/src/main/java/com/elymbot/android/core/common/logging/RuntimeLogCleanupRepository.kt",
        )
