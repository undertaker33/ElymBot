package com.elymbot.android.core.runtime.tool
...
class ToolJsonValueNormalizerTest {
    ...
    private val sourceRoots: List<Path> = listOf(
        ...
        projectRoot.resolve("core/runtime-context/src/main/java/com/elymbot/android"),
    ...
    fun shared_json_normalizer_source_must_exist_and_replace_local_recursive_helpers() {
        val helperFile = projectRoot.resolve(
            "core/runtime-tool/src/main/java/com/elymbot/android/core/runtime/tool/ToolJsonValueNormalizer.kt",
        )
        assertTrue(
        ...
        assertTrue(
            ...
            !projectRoot.resolve(
                "core/runtime/src/main/java/com/elymbot/android/core/runtime/tool/ToolJsonValueNormalizer.kt",
            ).exists(),
        )
