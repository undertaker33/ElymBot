...
internal fun currentMainSwipePage(
    ...
    botWorkspaceTab: com.elymbot.android.ui.bot.BotWorkspaceTab,
    pluginWorkspaceTab: com.elymbot.android.ui.plugin.PluginWorkspaceTab,
): MainSwipePage {
...
internal fun mainSwipePageForBotWorkspaceTab(tab: com.elymbot.android.ui.bot.BotWorkspaceTab): MainSwipePage {
    return when (tab) {
        com.elymbot.android.ui.bot.BotWorkspaceTab.BOTS -> MainSwipePage.BOTS
        com.elymbot.android.ui.bot.BotWorkspaceTab.MODELS -> MainSwipePage.MODELS
        com.elymbot.android.ui.bot.BotWorkspaceTab.PERSONAS -> MainSwipePage.PERSONAS
    }
}

internal fun mainSwipePageForPluginWorkspaceTab(tab: com.elymbot.android.ui.plugin.PluginWorkspaceTab): MainSwipePage {
    return when (tab) {
        com.elymbot.android.ui.plugin.PluginWorkspaceTab.LOCAL -> MainSwipePage.PLUGINS_LOCAL
        com.elymbot.android.ui.plugin.PluginWorkspaceTab.MARKET -> MainSwipePage.PLUGINS_MARKET
    }
}

internal fun botWorkspaceTabForMainSwipePage(page: MainSwipePage): com.elymbot.android.ui.bot.BotWorkspaceTab? {
    return when (page) {
        MainSwipePage.BOTS -> com.elymbot.android.ui.bot.BotWorkspaceTab.BOTS
        MainSwipePage.MODELS -> com.elymbot.android.ui.bot.BotWorkspaceTab.MODELS
        MainSwipePage.PERSONAS -> com.elymbot.android.ui.bot.BotWorkspaceTab.PERSONAS
        else -> null
    }
}

internal fun pluginWorkspaceTabForMainSwipePage(page: MainSwipePage): com.elymbot.android.ui.plugin.PluginWorkspaceTab? {
    return when (page) {
        MainSwipePage.PLUGINS_LOCAL -> com.elymbot.android.ui.plugin.PluginWorkspaceTab.LOCAL
        MainSwipePage.PLUGINS_MARKET -> com.elymbot.android.ui.plugin.PluginWorkspaceTab.MARKET
        else -> null
    }
}
