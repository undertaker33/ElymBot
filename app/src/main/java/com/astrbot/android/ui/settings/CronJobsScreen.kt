...
internal fun CronJobsScreen(
    ...
    val botProfiles by BotRepository.botProfiles.collectAsState()
    val selectedBotId by BotRepository.selectedBotId.collectAsState()
...
internal fun CronJobsContent(
    ...
    botProfiles: List<BotProfile> = BotRepository.snapshotProfiles(),
    selectedBotId: String = BotRepository.selectedBotId.value,
