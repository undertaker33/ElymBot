...
object PluginUiSpec {
    ...
    const val DetailRecoveryTag = "plugin-detail-recovery"
    ...
    const val DetailOpenTriggersActionTag = "plugin-detail-open-triggers-action"
    ...
    const val DetailRetryActionTag = "plugin-detail-retry-action"
    ...
    const val DetailCopyDiagnosticsActionTag = "plugin-detail-copy-diagnostics-action"
