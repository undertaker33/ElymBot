...
import com.elymbot.android.core.runtime.search.WebSearchTriggerRules
...
import com.elymbot.android.feature.plugin.domain.runtime.PluginProviderMessageTextPart
import com.elymbot.android.feature.plugin.domain.runtime.PluginToolResult
import com.elymbot.android.feature.plugin.domain.runtime.PluginToolResultStatus
...
internal class QqStreamingReplyService(
    ...
    private val webSearchPromptStrings: WebSearchPromptStringProvider = QqWebSearchPromptStringProvider(),
) {
    fun prepareReply(
