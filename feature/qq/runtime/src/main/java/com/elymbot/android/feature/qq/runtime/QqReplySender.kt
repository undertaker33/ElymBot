...
import com.elymbot.android.feature.qq.runtime.QqOneBotPayloadCodec
import com.elymbot.android.feature.plugin.domain.runtime.PluginV2HostSendResult
import com.elymbot.android.feature.qq.runtime.QqReplyDecoration
import com.elymbot.android.feature.qq.runtime.QqReplyFormatter
...
internal class QqReplySender(
    ...
    fun sendWithOutcome(payload: QqReplyPayload, originalMessage: IncomingQqMessage): PluginV2HostSendResult {
        ...
        val action = JSONObject().apply {
            ...
            put("params", params)
            put("echo", "elymbot-${System.currentTimeMillis()}")
        }
        return try {
