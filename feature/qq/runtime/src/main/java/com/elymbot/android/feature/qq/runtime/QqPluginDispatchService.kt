...
import com.elymbot.android.feature.plugin.domain.runtime.PluginExecutionOutcome
...
import com.elymbot.android.feature.plugin.domain.runtime.PluginV2CommandResponse
import com.elymbot.android.feature.plugin.domain.runtime.PluginV2CommandResponseAttachment
...
internal class QqPluginDispatchService(
    ...
    private val hostActionExecutor: Any? = null,
    private val gatewayFactory: PluginHostCapabilityGatewayFactory? = null,
    private val log: (String) -> Unit = {},
    private val dispatchEngine: Any? = null,
    private val messageDispatchPort: PluginV2MessageDispatchPort = PluginV2MessageDispatchPort {
        ...
        return runCatching {
            runBlocking {
                messageDispatchPort.dispatchMessage(
                    materializedEvent ?: message.toPluginMessageEvent(
                        trigger = trigger,
    ...
    private fun consumePluginOutcome(
        ...
        when (val result = outcome.result) {
            ...
            is HostActionRequest -> {
                ...
                val executionGateway = gatewayFactory?.create(
                ...
                val execution = executionGateway.executeHostAction(
    ...
    private fun IncomingMessageEvent.toIncomingQqMessage(): IncomingQqMessage {
        return IncomingQqMessage(
            ...
            conversationId = if (messageType == com.elymbot.android.model.chat.MessageType.GroupMessage) groupId else userId,
            messageId = messageId,
            text = text,
...
private fun IncomingQqMessage.fallbackConversationId(): String {
    return when (messageType) {
        com.elymbot.android.model.chat.MessageType.GroupMessage -> "group:$groupIdOrBlank"
        com.elymbot.android.model.chat.MessageType.FriendMessage,
        com.elymbot.android.model.chat.MessageType.OtherMessage,
        -> "friend:$senderId"
    }
}
