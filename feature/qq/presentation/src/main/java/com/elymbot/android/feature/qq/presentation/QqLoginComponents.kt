...
import com.elymbot.android.ui.viewmodel.buildQqLoginVersionMarker
        ...
        <body>
          ...
          <script>
            ...
            function setStatus(message) {
              if (window.ElymBotCaptchaBridge) {
                window.ElymBotCaptchaBridge.onStatus(message);
              }
            }
            function finishSuccess(ticket, randstr, sid) {
              if (window.ElymBotCaptchaBridge) {
                window.ElymBotCaptchaBridge.onSuccess(ticket, randstr, sid || '');
              }
            }
            function finishCancel() {
              if (window.ElymBotCaptchaBridge) {
                window.ElymBotCaptchaBridge.onCancel();
              }
            }
