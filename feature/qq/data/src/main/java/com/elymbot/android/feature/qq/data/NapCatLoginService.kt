...
class NapCatLoginService @Inject constructor(
    ...
    internal fun setHttpClientOverrideForTests(override: ElymBotHttpClient?) {
        httpClient = override ?: OkHttpElymBotHttpClient(
            transport = OkHttpRuntimeNetworkTransport(),
        )
    }
    ...
    private fun classifyFailure(
        ...
        return when {
            ...
            cause is ElymBotHttpException && cause.category == HttpFailureCategory.TIMEOUT -> LoginFailureCategory.NETWORK_FAILURE
            cause is ElymBotHttpException && cause.category == HttpFailureCategory.NETWORK -> LoginFailureCategory.NETWORK_FAILURE
