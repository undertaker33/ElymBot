...
import com.elymbot.android.feature.plugin.domain.runtime.ExternalPluginHostActionHandlers
import com.elymbot.android.feature.plugin.domain.runtime.PluginHostCapabilityGateway
import com.elymbot.android.feature.plugin.domain.runtime.PluginDispatchSkipReason
...
import com.elymbot.android.feature.plugin.runtime.HOST_SKIP_COMMAND_STAGE_EXTRA_KEY
...
class AppChatPluginCommandService(
    ...
    fun isUnsupportedPluginCommand(content: String): Boolean {
        val parsedCommand = com.elymbot.android.feature.chat.runtime.botcommand.BotCommandParser.parse(content) ?: return false
        return !com.elymbot.android.feature.chat.runtime.botcommand.BotCommandRouter.supports(parsedCommand.name)
    }
