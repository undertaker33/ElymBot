...
import com.elymbot.android.feature.chat.domain.AppChatRequest
import com.elymbot.android.feature.chat.domain.AppChatRuntimeEvent
        ...
        try {
            ...
            val callbacks = object : PlatformLlmCallbacks {
                ...
                override suspend fun invokeProvider(
                    ...
                    ctx: com.elymbot.android.core.runtime.context.ResolvedRuntimeContext,
