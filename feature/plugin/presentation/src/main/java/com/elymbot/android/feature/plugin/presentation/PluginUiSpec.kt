...
import com.elymbot.android.model.plugin.PluginUiActionStyle
import com.elymbot.android.model.plugin.PluginUiStatus
...
object PluginUiSpec {
    ...
    const val InstalledLibrarySummaryTag = "plugin-installed-library-summary"
    const val InstalledLibraryBulkActionsTag = "plugin-installed-library-bulk-actions"
    ...
    const val MarketPagerPreviousActionTag = "plugin-market-pager-previous"
    const val MarketPagerNextActionTag = "plugin-market-pager-next"
    const val MarketPagerJumpActionTag = "plugin-market-pager-jump"
    const val MarketPagerJumpDialogTag = "plugin-market-pager-jump-dialog"
    const val MarketDetailPageTag = "plugin-market-detail-page"
    const val MarketDetailBackActionTag = "plugin-market-detail-back-action"
    const val MarketDetailTopSummaryTag = "plugin-market-detail-top-summary"
    const val MarketDetailOverviewTag = "plugin-market-detail-overview"
    const val MarketDetailActionsTag = "plugin-market-detail-actions"
    const val MarketDetailVersionOptionsTag = "plugin-market-detail-version-options"
    const val MarketDetailRepositoryActionTag = "plugin-market-detail-repository-action"
    const val MarketDetailPrimaryActionTag = "plugin-market-detail-primary-action"
    ...
    const val DetailUnderstandTag = "plugin-detail-understand"
    const val DetailManageTag = "plugin-detail-manage"
    ...
    const val DetailRestoreDefaultsActionTag = "plugin-detail-restore-defaults-action"
    const val DetailClearCacheActionTag = "plugin-detail-clear-cache-action"
    ...
    const val DetailConfirmDialogTag = "plugin-detail-confirm-dialog"
    ...
    const val ConfigDataSectionTag = "plugin-config-data-section"
    const val ConfigEmptyStateTag = "plugin-config-empty-state"
    const val ConfigSaveFabTag = "plugin-config-save-fab"
    const val WorkspacePageTag = "plugin-workspace-page"
    const val WorkspaceSummaryTag = "plugin-workspace-summary"
    const val WorkspaceResourceSectionTag = "plugin-workspace-resource-section"
    const val WorkspaceImportSectionTag = "plugin-workspace-import-section"
    const val WorkspaceExportSectionTag = "plugin-workspace-export-section"
    const val WorkspaceCacheSectionTag = "plugin-workspace-cache-section"
    const val WorkspaceDebugSectionTag = "plugin-workspace-debug-section"
    ...
    const val PluginLogsPageTag = "plugin-logs-page"
    const val PluginLogsCopyActionTag = "plugin-logs-copy-action"
    const val PluginLogsClearActionTag = "plugin-logs-clear-action"
    const val PluginLogsCleanupActionTag = "plugin-logs-cleanup-action"
    const val PluginLogsCleanupDialogTag = "plugin-logs-cleanup-dialog"
    const val PluginTriggersPageTag = "plugin-triggers-page"
    ...
    fun installedLibraryBulkActionTag(actionKey: String): String = "plugin-installed-library-bulk-action-${toTagSegment(actionKey)}"
