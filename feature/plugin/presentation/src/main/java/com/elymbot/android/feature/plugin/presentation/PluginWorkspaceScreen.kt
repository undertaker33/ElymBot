...
import com.elymbot.android.ui.viewmodel.PluginHostWorkspaceUiState
...
fun PluginWorkspaceScreenRoute(
    ...
    RegisterSecondaryTopBar(
        route = PluginPresentationRoutes.Workspace,
...
private fun PluginWorkspacePage(
    ...
    onSettingsDraftChange: (String, com.elymbot.android.ui.viewmodel.PluginSettingDraftValue) -> Unit,
) {
...
private fun WorkspaceFileList(
    files: List<com.elymbot.android.ui.viewmodel.PluginHostWorkspaceFileUiState>,
    emptyMessage: String,
    onDeleteFile: (String) -> Unit,
    allowDelete: Boolean,
) {
