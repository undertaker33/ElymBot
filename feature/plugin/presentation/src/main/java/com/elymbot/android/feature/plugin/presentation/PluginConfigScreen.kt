...
import com.elymbot.android.ui.plugin.schema.PluginStaticConfigRenderer
import com.elymbot.android.ui.plugin.schema.buildPluginStaticConfigRenderModel
...
fun PluginConfigScreenRoute(
    ...
    RegisterSecondaryTopBar(
        route = PluginPresentationRoutes.Config,
...
private fun PluginConfigWorkspace(
    ...
    onSettingsDraftChange: (fieldId: String, draftValue: com.elymbot.android.ui.viewmodel.PluginSettingDraftValue) -> Unit,
    onStaticConfigDraftChange: (fieldKey: String, draftValue: com.elymbot.android.ui.viewmodel.PluginSettingDraftValue) -> Unit,
    onSaveConfig: () -> Unit,
) {
