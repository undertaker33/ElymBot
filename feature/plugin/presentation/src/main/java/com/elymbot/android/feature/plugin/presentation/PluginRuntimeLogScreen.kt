...
import com.elymbot.android.ui.common.TimedCleanupDialog
import com.elymbot.android.ui.common.formatTimedCleanupInterval
...
fun PluginRuntimeLogScreenRoute(
    ...
    SubPageScaffold(
        route = PluginPresentationRoutes.Logs,
...
internal fun buildPluginRuntimeLogText(
    records: List<com.elymbot.android.model.plugin.PluginRuntimeLogRecord>,
): String {
