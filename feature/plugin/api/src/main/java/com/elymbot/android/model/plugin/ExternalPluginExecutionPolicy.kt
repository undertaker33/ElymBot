...
object ExternalPluginMediaSourceResolver {
    ...
    fun resolve(
        ...
        return when {
            ...
            source.startsWith(PackagePrefix) -> {
                ...
                val rootPath = File(pluginRoot).canonicalFile.toPath()
                val candidate = File(pluginRoot, relativePath).canonicalFile.toPath()
            ...
            source.startsWith(WorkspacePrefix) -> {
                ...
                val candidate = resolveWorkspaceFile(
    ...
    private fun resolveWorkspaceFile(
        privateRootPath: String,
        relativePath: String,
    ): File {
