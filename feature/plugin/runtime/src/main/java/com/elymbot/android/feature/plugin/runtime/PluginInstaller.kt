...
import com.elymbot.android.download.DownloadTaskStatus
import com.elymbot.android.feature.plugin.data.PluginInstallStore
...
import com.elymbot.android.model.plugin.toSnapshot
import java.io.File
...
class DownloadManagerRemotePluginPackageDownloader @Inject constructor(
    ...
    override suspend fun download(
        ...
        downloadManager.awaitCompletion(taskKey) { task ->
