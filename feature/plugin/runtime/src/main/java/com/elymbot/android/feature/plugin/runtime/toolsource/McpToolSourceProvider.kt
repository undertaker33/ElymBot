...
import com.elymbot.android.feature.plugin.runtime.mcp.McpSessionManager
import com.elymbot.android.feature.plugin.runtime.toMcpServerEntry
...
class McpToolSourceProvider @Inject constructor(
    ...
    private fun buildBindingsForServer(
        ...
        tools: List<com.elymbot.android.feature.plugin.runtime.mcp.McpDiscoveredTool>,
    ): List<ToolSourceDescriptorBinding> {
