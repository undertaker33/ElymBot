...
import com.elymbot.android.feature.cron.domain.CronExpressionParser
...
typealias ActiveCapabilityTargetContext = com.elymbot.android.feature.cron.domain.ActiveCapabilityTargetContext
...
class ActiveCapabilityRuntimeFacade(
    ...
    suspend fun createFutureTask(request: ActiveCapabilityCreateTaskRequest): ActiveCapabilityTaskCreation {
        ...
        val target = request.targetContext ?: resolveTargetContext(request)
...
private fun resolveTargetContext(request: ActiveCapabilityCreateTaskRequest): ActiveCapabilityTargetContext {
