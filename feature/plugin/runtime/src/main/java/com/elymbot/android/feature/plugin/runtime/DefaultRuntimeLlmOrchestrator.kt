...
import com.elymbot.android.core.runtime.context.PromptAssembler
import com.elymbot.android.core.runtime.context.StreamingModeResolver
import com.elymbot.android.feature.plugin.runtime.MessageConverters.toPluginProviderMessages
 ...
 */
class DefaultRuntimeLlmOrchestrator : RuntimeLlmOrchestratorPort {
    ...
    override suspend fun dispatchLlm(
        ...
        val systemPrompt = PromptAssembler.assemble(ctx)
