...
internal class PluginV2LlmPipelineCoordinator(
    ...
    suspend fun deliverLlmPipeline(
        ...
        if (!pipelineResult.sendableResult.shouldSend) {
            return PluginV2HostLlmDeliverySuppressed(pipelineResult)
        }
        ...
        if (!sendResult.success) {
            ...
            return PluginV2HostLlmDeliverySendFailed(
        ...
        val afterSentView = eventResultCoordinator.buildAfterSentView(
            ...
            sentAtEpochMs = clock(),
            deliveryStatus = PluginV2AfterSentDeliveryStatus.SUCCESS,
        ...
        return PluginV2HostLlmDeliverySent(
            pipelineResult = pipelineResult,
    ...
    private fun aggregateProviderInvocation(
        ...
        return when (invocation) {
            is PluginV2ProviderInvocationNonStreaming -> invocation.response.sanitizedCopy()
            is PluginV2ProviderInvocationStreaming -> {
