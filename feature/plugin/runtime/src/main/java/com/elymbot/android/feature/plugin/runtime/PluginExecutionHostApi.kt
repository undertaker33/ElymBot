...
import com.elymbot.android.feature.plugin.data.config.ResolvedPluginHostConfig
import com.elymbot.android.feature.persona.domain.model.PersonaToolEnablementSnapshot
import com.elymbot.android.model.plugin.ExternalPluginRuntimeKind
...
interface PluginExecutionHostOperations {
...
@Singleton
class DefaultPluginExecutionHostOperations(
    private val hostConfigResolver: PluginHostConfigResolver = NoopPluginHostConfigResolver(),
...
private class NoopPluginHostConfigResolver : PluginHostConfigResolver {
...
object PluginExecutionHostApi {
    ...
    private val compatOperations: PluginExecutionHostOperations = DefaultPluginExecutionHostOperations(
        hostConfigResolver = NoopPluginHostConfigResolver(),
    )
