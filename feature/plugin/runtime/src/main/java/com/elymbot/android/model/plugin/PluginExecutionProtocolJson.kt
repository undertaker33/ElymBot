...
import com.elymbot.android.feature.plugin.runtime.AllowedValue
...
import com.elymbot.android.feature.plugin.runtime.PluginMessageEventAttachmentMutationIntent
import com.elymbot.android.feature.plugin.runtime.PluginMessageEventResult
import com.elymbot.android.feature.plugin.runtime.PluginMessageEventResultAttachment
import com.elymbot.android.feature.plugin.runtime.PluginProviderAssistantToolCall
import com.elymbot.android.feature.plugin.runtime.PluginProviderMessageDto
import com.elymbot.android.feature.plugin.runtime.PluginProviderMessageMediaRefPart
import com.elymbot.android.feature.plugin.runtime.PluginProviderMessagePartDto
import com.elymbot.android.feature.plugin.runtime.PluginProviderMessageTextPart
import com.elymbot.android.feature.plugin.runtime.PluginProviderMessageRole
...
import com.elymbot.android.feature.plugin.runtime.PluginV2AfterSentDeliveredEntry
import com.elymbot.android.feature.plugin.runtime.PluginV2AfterSentDeliveryStatus
import com.elymbot.android.feature.plugin.runtime.PluginV2AfterSentView
import com.elymbot.android.feature.plugin.runtime.PluginV2ValueSanitizer
...
object PluginExecutionProtocolJson {
    ...
    fun encodePluginProviderMessagePartDto(part: PluginProviderMessagePartDto): JSONObject {
        return when (part) {
            is PluginProviderMessageTextPart -> JSONObject().apply {
                put("partType", "text")
                put("text", part.text)
            }

            is PluginProviderMessageMediaRefPart -> JSONObject().apply {
    ...
    fun decodePluginProviderMessagePartDto(json: JSONObject): PluginProviderMessagePartDto {
        return when (readRequiredString(json, "partType", "partType")) {
            "text" -> PluginProviderMessageTextPart(
                text = readRequiredString(json, "text", "text"),
            )

            "media_ref" -> PluginProviderMessageMediaRefPart(
    ...
    private fun encodePluginV2AfterSentEntry(entry: PluginV2AfterSentDeliveredEntry): JSONObject {
        return JSONObject().apply {
    ...
    private fun decodePluginV2AfterSentEntries(array: JSONArray?, path: String): List<PluginV2AfterSentDeliveredEntry> {
        if (array == null) return emptyList()
        return buildList {
            for (index in 0 until array.length()) {
                val json = array.optJSONObject(index)
    ...
    private fun encodePluginMessageEventResultAttachment(attachment: PluginMessageEventResultAttachment): JSONObject {
        return JSONObject().apply {
    ...
    private fun decodePluginMessageEventResultAttachments(array: JSONArray?, path: String): List<PluginMessageEventResultAttachment> {
        if (array == null) return emptyList()
        return buildList {
            for (index in 0 until array.length()) {
                val json = array.optJSONObject(index)
    ...
    private fun decodePluginMessageEventResultAttachmentMutationIntent(
        value: String?,
        attachments: List<PluginMessageEventResultAttachment>,
    ): PluginMessageEventAttachmentMutationIntent {
        if (value.isNullOrBlank()) {
            return if (attachments.isEmpty()) {
                PluginMessageEventAttachmentMutationIntent.UNTOUCHED
            } else {
                PluginMessageEventAttachmentMutationIntent.REPLACED
            }
        }
        return try {
            PluginMessageEventAttachmentMutationIntent.valueOf(value)
    ...
    private fun decodePluginV2AfterSentDeliveryStatus(value: String): PluginV2AfterSentDeliveryStatus {
        return PluginV2AfterSentDeliveryStatus.fromWireValue(value)
