...
import com.astrbot.android.feature.cron.domain.EmptyActiveCapabilityPromptStrings
...
private object EmptyCronSchedulerPort : com.astrbot.android.feature.cron.domain.CronSchedulerPort {
    override fun schedule(job: com.astrbot.android.feature.cron.domain.model.CronJob) = Unit
...
private class EmptyCronJobRepositoryPort : com.astrbot.android.feature.cron.domain.CronJobRepositoryPort {
    override val jobs = kotlinx.coroutines.flow.MutableStateFlow(emptyList<com.astrbot.android.feature.cron.domain.model.CronJob>())

    override suspend fun create(job: com.astrbot.android.feature.cron.domain.model.CronJob): com.astrbot.android.feature.cron.domain.model.CronJob = job

    override suspend fun update(job: com.astrbot.android.feature.cron.domain.model.CronJob): com.astrbot.android.feature.cron.domain.model.CronJob = job

    override suspend fun delete(jobId: String) = Unit

    override suspend fun getByJobId(jobId: String): com.astrbot.android.feature.cron.domain.model.CronJob? = null

    override suspend fun listAll(): List<com.astrbot.android.feature.cron.domain.model.CronJob> = emptyList()

    override suspend fun listEnabled(): List<com.astrbot.android.feature.cron.domain.model.CronJob> = emptyList()
    ...
    override suspend fun recordExecutionStarted(
        record: com.astrbot.android.feature.cron.domain.model.CronJobExecutionRecord,
    ): com.astrbot.android.feature.cron.domain.model.CronJobExecutionRecord = record
    ...
    override suspend fun listRecentExecutionRecords(
        jobId: String,
        limit: Int,
    ): List<com.astrbot.android.feature.cron.domain.model.CronJobExecutionRecord> = emptyList()

    override suspend fun latestExecutionRecord(
        jobId: String,
    ): com.astrbot.android.feature.cron.domain.model.CronJobExecutionRecord? = null
}
