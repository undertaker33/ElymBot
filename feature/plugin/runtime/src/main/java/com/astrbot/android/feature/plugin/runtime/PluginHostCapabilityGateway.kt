...
interface PluginHostCapabilityGateway : com.astrbot.android.feature.plugin.domain.runtime.PluginHostCapabilityGateway {
...
internal fun com.astrbot.android.feature.plugin.domain.runtime.PluginHostCapabilityGateway.requireRuntimeGateway():
    PluginHostCapabilityGateway {
    return this as? PluginHostCapabilityGateway
        ?: error("PluginHostCapabilityGateway must be provided by feature:plugin:runtime.")
}
