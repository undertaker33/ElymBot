...
class PluginRuntimeHiltOwnershipContractTest {
    ...
    fun plugin_runtime_log_bus_and_cleanup_are_hilt_owned_services() {
        val logBus = productionFile("feature/plugin/runtime/src/main/java/com/elymbot/android/feature/plugin/runtime/PluginRuntimeLogBus.kt")
            .readText()
        val cleanup = productionFile("feature/plugin/runtime/src/main/java/com/elymbot/android/feature/plugin/runtime/PluginRuntimeLogCleanupRepository.kt")
            .readText()
