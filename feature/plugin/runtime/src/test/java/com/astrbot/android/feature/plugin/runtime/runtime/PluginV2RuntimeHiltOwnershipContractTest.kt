...
class PluginV2RuntimeHiltOwnershipContractTest {
    ...
    fun plugin_v2_runtime_hotspots_are_constructor_owned_not_static_provider_owned() {
        val hotspotFiles = listOf(
            "feature/plugin/runtime/src/main/java/com/astrbot/android/feature/plugin/runtime/PluginV2ActiveRuntimeStore.kt",
            "feature/plugin/runtime/src/main/java/com/astrbot/android/feature/plugin/runtime/PluginV2DispatchEngine.kt",
            "feature/plugin/runtime/src/main/java/com/astrbot/android/feature/plugin/runtime/PluginV2LifecycleManager.kt",
            "feature/plugin/runtime/src/main/java/com/astrbot/android/feature/plugin/runtime/PluginV2RuntimeLoader.kt",
        )
