...
fun buildSupportedHostToolCards(): List<HostToolCardPresentation> {
    return listOf(
...
fun buildHostToolPagerPresentation(
...
fun buildResourceListPresentation(
    kind: ResourceKind,
...
fun buildCronJobRunPresentations(
