...
import com.elymbot.android.feature.resource.presentation.ResourceCenterPresentationController
...
private const val ResourceCenterRoute = "resource-center"
private const val ResourceListRoute = "resource-center/{resourceType}"

private object ResourceCenterUiSpec {
    val ScreenHorizontalPadding = 14.dp
    val ScreenVerticalPadding = 14.dp
    val SectionSpacing = 12.dp
    val ListContentBottomPadding = 104.dp
...
@Composable
private fun ResourceEntryListPage(
    entries: List<ResourceEntryCardState>,
...
@Composable
private fun ResourceEntryCard(entry: ResourceEntryCardState) {
    Surface(
...
private data class ResourceEntryCardState(
    val title: String,
    val subtitle: String,
    ...
    ResourceSubPageScaffold(
        ...
        Box(
            ...
            LazyColumn(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(horizontal = ResourceCenterUiSpec.ScreenHorizontalPadding),
                contentPadding = PaddingValues(
                    top = ResourceCenterUiSpec.ScreenVerticalPadding,
                    bottom = ResourceCenterUiSpec.ListContentBottomPadding,
                ),
                verticalArrangement = Arrangement.spacedBy(ResourceCenterUiSpec.SectionSpacing),
            ) {
...
private fun ResourceCard(card: ResourceCardPresentation) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        shape = ResourceCenterUiSpec.SectionShape,
        color = MonochromeUi.cardBackground,
        tonalElevation = 0.dp,
...
private fun ResourceStatusBadge(text: String) {
    Surface(
        shape = ResourceCenterUiSpec.BadgeShape,
        ...
        Box(
            ...
            Column(
                ...
                HorizontalPager(
                    state = pagerState,
                    modifier = Modifier.weight(1f),
                    pageSpacing = ResourceCenterUiSpec.SectionSpacing,
                    ...
                    LazyColumn(
                        ...
                        contentPadding = PaddingValues(
                            top = ResourceCenterUiSpec.ScreenVerticalPadding,
                            bottom = ResourceCenterUiSpec.SectionSpacing,
                        ),
                        verticalArrangement = Arrangement.spacedBy(ResourceCenterUiSpec.SectionSpacing),
                    ) {
                        items(
                ...
                SettingsPagerBar(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(bottom = ResourceCenterUiSpec.ScreenVerticalPadding),
                )
            }
        }
    }
