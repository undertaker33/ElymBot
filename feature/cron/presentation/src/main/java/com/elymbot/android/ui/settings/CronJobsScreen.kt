...
import com.elymbot.android.feature.cron.domain.ActiveCapabilityTargetContext
...
@Composable
fun CronJobsScreen(onBack: () -> Unit) {
    CronJobsScreenRoute(
        onBack = onBack,
...
@Composable
internal fun CronJobsScreenRoute(
    onBack: () -> Unit,
...
private const val CronJobsRoute = "cron-jobs"

@Composable
private fun SettingsPagerBar(
    currentPage: Int,
    totalPages: Int,
...
internal fun CronJobsContent(
    ...
    val page = buildCronJobsUiPresentation(jobs = jobs, requestedPage = requestedPage)
    ...
    LaunchedEffect(jobs.size) {
        requestedPage = buildCronJobsUiPresentation(jobs = jobs, requestedPage = requestedPage).currentPage
    }
        ...
        AlertDialog(
            ...
            text = {
                OutlinedTextField(
                    ...
                    colors = com.elymbot.android.ui.app.monochromeOutlinedTextFieldColors(),
                )
            },
            confirmButton = {
                TextButton(
    ...
    Box(
        ...
        Column(
            ...
            HorizontalPager(
                ...
                val pageForIndex = buildCronJobsUiPresentation(
                    jobs = jobs,
...
private fun CronJobCard(
    job: CronJobUiListItemPresentation,
        ...
        text = {
            Column(
                ...
                when {
                    ...
                    else -> buildCronJobRunUiPresentations(state.runs).forEach { run ->
