...
class CronCompatContractTest {
    ...
    fun work_manager_scheduler_and_ports_are_injectable() {
        ...
        val requiredConstructors = mapOf(
            "feature/cron/runtime/src/main/java/com/elymbot/android/feature/cron/runtime/CronJobScheduler.kt" to
                "class WorkManagerCronJobScheduler @Inject constructor",
            "feature/cron/runtime/src/main/java/com/elymbot/android/feature/cron/runtime/FeatureCronSchedulerPortAdapter.kt" to
                "class FeatureCronSchedulerPortAdapter @Inject constructor",
            "feature/cron/runtime/src/main/java/com/elymbot/android/feature/cron/runtime/WorkManagerCronRescheduler.kt" to
