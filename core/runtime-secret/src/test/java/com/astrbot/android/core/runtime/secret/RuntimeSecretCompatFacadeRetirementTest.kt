...
class RuntimeSecretCompatFacadeRetirementTest {
    ...
    fun production_secret_module_does_not_keep_static_compat_facades() {
        ...
        val retiredFacades = listOf(
            "com/astrbot/android/core/runtime/secret/AppSecretStore.kt" to "object AppSecretStore",
            "com/astrbot/android/core/runtime/secret/RuntimeSecretRepository.kt" to "object RuntimeSecretRepository",
        )
