...
import com.elymbot.android.core.runtime.search.profile.encodeQuery
...
class BraveSearchProvider(
    ...
    override fun supports(profile: ConfiguredSearchProfile): Boolean {
        return profile.enabled && profile.providerType == ConfiguredSearchProviderType.BRAVE_SEARCH && profile.apiKey.isNotBlank()
    }
