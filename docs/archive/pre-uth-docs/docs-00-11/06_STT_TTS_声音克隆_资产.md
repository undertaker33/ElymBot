...
- `feature/voiceasset/api/src/main/java/com/elymbot/android/feature/voiceasset/api/VoiceAssetPorts.kt`
- `feature/voiceasset/api/src/main/java/com/elymbot/android/feature/voiceasset/api/model/RuntimeAssetModels.kt`
- `feature/voiceasset/api/src/main/java/com/elymbot/android/feature/voiceasset/api/model/TtsVoiceModels.kt`
- `feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/RuntimeAssetRepository.kt`
- `feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/TtsVoiceAssetRepository.kt`
- `feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/VoiceCloneService.kt`
...
- `feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/RuntimeAssetRepository.kt`
- Hilt binding：`feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/VoiceAssetDataModule.kt`

它是资产状态/下载入口的一部分。具体音频 runtime 实现则在 `core/runtime/audio/*`。

UI 已迁移/拆分：

- 资产入口页面：`feature/voiceasset/presentation/src/main/java/com/elymbot/android/ui/settings/AssetScreens.kt`
- voice asset 组件：`feature/voiceasset/presentation/src/main/java/com/elymbot/android/ui/voiceasset/*`
- `RuntimeAssetViewModel`：`feature/voiceasset/presentation/src/main/java/com/elymbot/android/ui/settings/RuntimeAssetViewModel.kt`
...
- 音色资产真源：`feature/voiceasset/data/src/main/java/com/elymbot/android/feature/voiceasset/data/TtsVoiceAssetRepository.kt`
...
- `app/src/test/java/com/elymbot/android/data/db/tts/TtsVoiceAssetMappersTest.kt`
- `app/src/test/java/com/elymbot/android/data/backup/TtsBackupArchiveTest.kt`
- `app/src/test/java/com/elymbot/android/architecture/VoiceAssetModelOwnershipContractTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/ContainerBridgeRuntimeSupportTest.kt`
- `app/src/test/java/com/elymbot/android/core/runtime/container/RuntimeCompatibilityAliases.kt`
