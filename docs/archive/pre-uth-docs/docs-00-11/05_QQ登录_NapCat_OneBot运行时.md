...
- QQ 模块主目录：`feature/qq/{api,data,runtime,presentation}/`；`feature/qq/impl` 当前不承载 QQ production 主线；`app/src/main/java/com/elymbot/android/feature/qq/` 不再承载 QQ production 主线。
...
旧 `ElymBotAppContainer` / `ElymBotAppContainer` 不是当前生产入口。`QqOneBotBridgeServer` object 仍在 `QqOneBotBridgeServer.kt`，但主要作为 test/compat 静态入口；生产 app 启动不再手动 install 它的 runtime dependencies。
...
package 可能仍是旧 `com.elymbot.android.ui.qqlogin` / `ui.viewmodel`，以物理路径为准。
...
- `NapCatLoginService`
  - 通过 `ElymBotHttpClient` / `OkHttpElymBotHttpClient` 调 NapCat WebUI
...
- `app/src/test/java/com/elymbot/android/runtime/qq/QqKeywordDetectorTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqRateLimiterTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqReplyFormatterTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqReplyPolicyEvaluatorTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqSessionKeyFactoryTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqWakeWordPolicyTest.kt`
- `app/src/test/java/com/elymbot/android/runtime/qq/QqWhitelistMatcherTest.kt`
- `app/src/test/java/com/elymbot/android/data/NapCatLoginRepositoryTest.kt`
- `app/src/test/java/com/elymbot/android/data/NapCatLoginServiceTest.kt`
- `app/src/test/java/com/elymbot/android/ui/viewmodel/QQLoginViewModelTest.kt`
...
- `app/src/androidTest/java/com/elymbot/android/ui/qqlogin/SavedAccountDropdownTest.kt`
