...
- `docs/archive/pre-uth-docs/docs-00-11/02_数据真源_Room_Repository_备份基线.md`：保留为 `core-foundation-and-db` 辅助证据；其中 Room v22 仍与当前代码一致，但数据库入口应以当前 `core/db/src/main/java/com/astrbot/android/data/db/AstrBotDatabase.kt` 为准，不再使用旧 `app/src/main/java/.../AstrBotDatabase.kt` 路径。
